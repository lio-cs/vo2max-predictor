...
// Fitbit is the only integration that actually exists (Google Health API, see
// lib/googleHealth.ts) — Apple Watch/other wearables are a roadmap signal for the XPRIZE
// narrative, not a built feature. Keep it that way: no href, no OAuth flow, just a disabled card.
const WEARABLES: Wearable[] = [
  ...
  {
    name: "Apple Watch",
    description: "Apple Health support is on our roadmap.",
    href: null,
  },
  {
    name: "More wearables",
